...
frappe.ui.form.on('Book My Show', {
	 select_your_slots: function(frm,doctype,name) {
		...
		frappe.call({
			method: 'bookmyshow.book_my_show.doctype.book_my_show.book_my_show.get_available_seats',
			args: {
...
frappe.ui.form.on('Book My Show','onload',function(frm,doctype,name){
frm.set_query('theater', () => {
	return {
		query: 'bookmyshow.book_my_show.doctype.book_my_show.book_my_show.get_theater',
		filters: {
